...
namespace WebAppParcial1.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,CategoriaId,Precio,Marca,Favorito")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,CategoriaId,Precio,Marca,Favorito")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
